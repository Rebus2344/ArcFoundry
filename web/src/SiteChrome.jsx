...
export function SiteFooter({
  ...
  return <footer className="site-footer"><div className="footer-about"><Brand /><p>Unique factories. Real proof of work.<br />Your device. Your work. Your Foundry.</p><span className="footer-network"><i /> Arc Mainnet</span><p><a href="https://x.com/TheArcFoundry" target="_blank" rel="noopener noreferrer" aria-label="ArcFoundry on X (Twitter)">X (Twitter) · @TheArcFoundry ↗</a><br/><a href={collectionUrl(config)} target="_blank" rel="noopener noreferrer">OpenSea ↗</a><br/><a href="https://github.com/Rebus2344/ArcFoundry" target="_blank" rel="noopener noreferrer">GitHub ↗</a></p></div><div className="footer-links"><div><h2>THE APP</h2><a href="#/mine">Mine a Foundry</a><a href="#/collection">Explore Foundries</a><a href="#/account">My Foundries</a><a href="#/rent">Claim USDC rent</a><a href="#/token">Trade SCRAP</a></div><div><h2>THE RULES</h2><a href="#/docs">Documentation</a><a href="#/docs/factories">Onchain artwork</a><a href="#/economy">Economics</a><a href="#/stats">Network stats</a></div></div><div className="footer-bottom"><span>Every Foundry starts with a hash. <a href="#/privacy">Privacy</a></span><span>ARC MAINNET · PROOF OF WORK <BoneIcon /></span></div></footer>;
}
